...
const { PUBLIC_URL, TRANSLOADIT_AUTH_KEY, TRANSLOADIT_AUTH_SECRET } = process.env
...
export const get = async (body) =>
  new Promise(async (resolve, reject) => {
    ...
    try {
      ...
      resolve({ documentId, speakablesHash, derivativeId, webhookUrl, audioDuration, audioData })
    } catch (e) {
      console.error(e)
      reject(e)
    }
