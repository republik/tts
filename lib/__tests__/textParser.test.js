...
describe('text processing:parser:', () => {
  test('convert simple mdast into huebsch format', async () => {
    const speakableText = getSpeakableText(simpleInput)
    expect(speakableText).toEqual(simpleOutput)
  })

  test('convert mdast with list/quote into huebsch format', async () => {
    const speakableText = getSpeakableText(complexInput)
    expect(speakableText).toEqual(complexOutput)
  })
  ...
  test('multivoice texts', async () => {
    const speakableText = getSpeakableText(multivoiceInput)
    expect(speakableText).toEqual(multivoiceOutput)
  })
})
