...
describe('format credits', () => {
  test('should add notice about synthetic voice and remove date', async () => {
    ...
    expect(output).toEqual({
      authors: ['Markus Schärli'],
      text: 'Ein Beitrag von Markus Schärli, vorgelesen von einer synthetischen Stimme.',
    })
  })
  ...
  test('should handle multiple authors', async () => {
    ...
    const output = addTtsNotice(input)
    expect(output).toEqual({
      authors: ['Lesha Berezovskiy', 'Annette Keller'],
      text: 'Ein Beitrag von Lesha Berezovskiy und Annette Keller, vorgelesen von einer synthetischen Stimme.',
    })
  })
  ...
  test('should filter out illustrators etc.', async () => {
    ...
    const output = addTtsNotice(input)
    expect(output).toEqual({
      authors: ['Philipp Albrecht', 'Timo Kollbrunner'],
      text: 'Ein Beitrag von Philipp Albrecht und Timo Kollbrunner, vorgelesen von einer synthetischen Stimme.',
    })
  })
  ...
  test('should handle interview, kommentar, etc.', async () => {
    ...
    const output = addTtsNotice(input)
    expect(output).toEqual({
      authors: ['Priscilla Imboden'],
      text: 'Ein Beitrag von Priscilla Imboden, vorgelesen von einer synthetischen Stimme.',
    })
  })
  ...
  test('should fall back on the original credit string if it is unparsable', async () => {
    ...
    expect(output).toEqual({
      authors: [],
      text: "Dieser Beitrag wird von einer synthetischen Stimme vorgelesen. C'est Anna qui a écrit ça.",
    })
  })
  ...
  test('should handle updated texts', async () => {
    ...
    expect(output).toEqual({
      authors: ['David Bauer'],
      text: 'Ein Beitrag von David Bauer, vorgelesen von einer synthetischen Stimme.',
    })
  })
  ...
  test('should handle name with a von', async () => {
    ...
    const output = addTtsNotice(input)
    expect(output).toEqual({
      authors: ['Erika von Strudelheim'],
      text: 'Ein Beitrag von Erika von Strudelheim, vorgelesen von einer synthetischen Stimme.',
    })
  })
  ...
  test('should handle name with digits', async () => {
    ...
    expect(output).toEqual({
      authors: ['Erika Lamm'],
      text: 'Ein Beitrag von Erika Lamm, vorgelesen von einer synthetischen Stimme.',
    })
  })
